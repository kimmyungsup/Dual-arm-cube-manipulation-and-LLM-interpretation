...
class CubeInteractor:
    ...
    def register_face(self, colors: list[Color], frame) -> None:
        ...
        self.last_registered_msg = 'Registered face:' + str(colors[4])
        if colors[4].value not in self.last_registered_msg_list:
            self.last_registered_msg_list.append(colors[4].value)
        print(self.last_registered_msg)
